...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-white text-black border-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-slate-100 text-500",
        ...
        sidebar:'bg-transparent text-slate-500 border-2 border-tranparent hover:bg-slate-100 transition-none',
        sidebarOutline:'bg-sky-500/15 text-sky-500 border border-sky-300 border-2 hover:bg-sky-500/20 transition-none'
